...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            1024, #size
            fs, #samp_rate
            "Signal out decimated + filtered", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            fs, #samp_rate
            "Signal en sortie de l'ADC", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.epy_block_0 = epy_block_0.ADC_delta_sigma_sinus(Vpp=Vpp, enob=enob, upsampling=upsampling)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, upsampling)
        self.analog_sig_source_x_0 = analog.sig_source_f(fs, analog.GR_COS_WAVE, 500, 1, 0, 0)
        ...
        self.connect((self.blocks_repeat_0, 0), (self.qtgui_time_sink_x_0_2, 0))
    ...
    def set_fs(self, fs):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.fs, self.cutoff_freq, 1, window.WIN_HAMMING, 6.76))
        ...
        self.qtgui_time_sink_x_0_1.set_samp_rate(self.fs)
        self.qtgui_time_sink_x_0_2.set_samp_rate(self.fs)
    ...
    def set_upsampling(self, upsampling):
        ...
        self.epy_block_0.upsampling = self.upsampling
    ...
    def set_enob(self, enob):
        self.enob = enob
        self.epy_block_0.enob = self.enob
