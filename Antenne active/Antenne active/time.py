...
plot_IQ_symbols(symbols_out_demod_egal, title="Constellation dun element en temps") 
...
somme_signaux_time = np.zeros(len(signaux))

for i in range(N):
    for j in range(N):
        somme_signaux_time = somme_signaux_time +  signaux[:,i,j]
